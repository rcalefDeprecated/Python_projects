...
set logscale y
m=50; beta=30;
# fit  gumbel(x,m,beta) 'model_4.out' using 1:3 via m,beta
# fit  gumbel_P(x,m,beta) 'model_4.out' using 1:4 via m,beta
fit  log(gumbel_P(x,m,beta)) 'model_4.out' using 1:(log($4)) via m,beta
plot [10:400] gumbel(x,m,beta), 'model_4.out' using 1:3

print gumbel_P(388, m, beta), gumbel_P_approx(388, m, beta)
print "E-value=", gumbel_P(388, m, beta)


pause -1 "press return to continue"

set ylabel "E-value"
plot [10:400] gumbel_P(x,m,beta), 'model_4.out' using 1:4
...
# fit lognormal(x,mu,sigma) 'model_4.out' using 1:3 via mu,sigma
# fit lognormal_P(x,mu,sigma) 'model_4.out' using 1:4 via mu,sigma
fit log(lognormal_P(x,mu,sigma)) 'model_4.out' using 1:(log($4)) via mu,sigma

set logscale xy
set ylabel "probability"
plot [10:400] lognormal(x,mu,sigma), 'model_4.out' using 1:3

print "p-value=",lognormal_P(388, mu, sigma), "  E-value=",lognormal_P(388, mu, sigma)

pause -1 "press return to continue"

set ylabel "E-value"
plot [10:400] lognormal_P(x,mu,sigma), 'model_4.out' using 1:4
